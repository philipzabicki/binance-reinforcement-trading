...
def main(n_splits=2, max_iterations=MAX_ITERATIONS):
    ...
    if n_splits == 0:
        ...
        run_part(df.copy(), half_idx=0, ohlcv_np=ohlcv_np, trange_arr=trange_arr, max_iterations=max_iterations)
        return
    ...
    for b_idx in range(n_splits):
        ...
        run_part(df_b, half_idx=b_idx, ohlcv_np=ohlcv_np, trange_arr=trange_arr, max_iterations=max_iterations)
