...
def main(max_iterations=10):
    ...
    with Pool(CPU_CORES_COUNT, initializer=pool_initializer, initargs=(np_df,)) as pool:
        ...
        while unmatched_segments.shape[0]:
            ...
            slowK, slowD = custom_StochasticOscillator(np_df,
            ...
            signals = np.array(func(k_line=slowK, d_line=slowD, oversold_threshold=best_params['oversold_threshold'],
        ...
        output_file = os.path.join(RESULTS_DIR, 'stoch_osc.csv')
