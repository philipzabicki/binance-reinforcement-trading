...
from utils.feature_generation import ohlcvvwap_initializer
...
def pool_initializer(ohlcv_np):
    ohlcvvwap_initializer(ohlcv_np)
...
def main(n_splits=2, max_iterations=MAX_ITERATIONS):
    ...
    if n_splits == 0:
        ...
        run_part(df.copy(), half_idx=0, ohlcv_np=ohlcvvwap_np, max_iterations=max_iterations)
        return
    ...
    for b_idx in range(n_splits):
        ...
        run_part(df_b, half_idx=b_idx, ohlcvvwap_np=ohlcvvwap_np, max_iterations=max_iterations)
